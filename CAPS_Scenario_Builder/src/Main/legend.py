    ...
    def __init__(self, parent, canvasLayer):
        ...
        if self.isVect:
            if geom == 1 or geom == 4 or geom == 8 or geom == 11: # Point
                icon.addPixmap(QtGui.QPixmap(resources_prefix + "mIconPointLayer.png"), 
                                                            QtGui.QIcon.Normal, QtGui.QIcon.On)
            elif geom == 2 or geom == 5 or geom == 9 or geom == 12: # Polyline
                icon.addPixmap(QtGui.QPixmap(resources_prefix + "mIconLineLayer.png"), 
                                                            QtGui.QIcon.Normal, QtGui.QIcon.On)
            elif geom == 3 or geom == 6 or geom == 10 or geom == 13: # Polygon
                icon.addPixmap(QtGui.QPixmap(resources_prefix + "mIconPolygonLayer.png"), 
                                                            QtGui.QIcon.Normal, QtGui.QIcon.On)
                ...
                if geom == 0: # Point
                    ...
                    icon.addPixmap(QtGui.QPixmap(resources_prefix + "mIconPolygonLayer.png"), 
                                                            QtGui.QIcon.Normal, QtGui.QIcon.On)
                else: raise RuntimeError, 'Unknown geometry: ' + str(geom)
