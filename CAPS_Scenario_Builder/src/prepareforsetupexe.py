...
# miscFiles = ["caps_setupexe.py", "csb_splash.png", "config.py", "make_setupexe.py", "resources_rc.py", "setup_program_icon.ico"]
# To expose config.py, comment out the miscFiles above and use the one below.
miscFiles = ["caps_setupexe.py", "csb_splash.png", "config.py", "make_setupexe_config.py", "resources_rc.py", "setup_program_icon.ico"]
