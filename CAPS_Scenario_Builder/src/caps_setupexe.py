...
def main(argv):
    ''' This is the entry point into the application. This Python file differs from caps.py because it has 
        settings used to create a standalone Windows installer versus running as a Python run. '''
